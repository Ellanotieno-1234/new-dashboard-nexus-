    ...
    <div className="w-full h-[300px]">
      <ResponsiveContainer width="100%" height="100%">
        ...
        >
          ...
          <Tooltip />
          <Legend />
          <Bar dataKey="demand" barSize={20} fill="#4f46e5" name="Current Demand" />
          <Bar dataKey="supply" barSize={20} fill="#16a34a" name="Current Supply" />
          <Line type="monotone" dataKey="forecast" stroke="#0891b2" name="Forecasted Demand" />
        </ComposedChart>
      </ResponsiveContainer>
    </div>
  )
